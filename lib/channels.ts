    ...
    formats: [
      {
        ...
        exampleImages: ['/images/google/example-ads.png'],
      },
    ],
  },
  {
    ...
    formats: [
      {
        ...
        guideImages: ['/images/instagram/guide-story.png', '/images/instagram/guide-feed.png', '/images/instagram/guide-explore.png'],
      },
    ],
  },
  {
    ...
    formats: [
      {
        ...
        guideImages: ['/images/naver-gfa/guide-layout.png', '/images/naver-gfa/guide-ad-mark.png'],
        exampleImages: ['/images/naver-gfa/example-news.png'],
      },
    ],
  },
  {
    ...
    formats: [
      {
        ...
        guideImages: ['/images/naver-ad/guide-cafe.png', '/images/naver-ad/guide-comment.png'],
      },
    ],
  },
  {
    ...
    formats: [
      {
        ...
        guideImages: ['/images/toss-list/guide-text.png'],
        exampleImages: ['/images/toss-list/example-kiwoom.png'],
      },
    ],
  },
  {
    ...
    formats: [
      {
        ...
        guideImages: ['/images/toss-benefit/guide-layout.png', '/images/toss-benefit/guide-safety-area.png'],
      },
    ],
  },
  {
    ...
    formats: [
      {
        ...
        guideImages: ['/images/kakao-bizboard/guide-upload-ui.png', '/images/kakao-bizboard/guide-list-layout.jpeg', '/images/kakao-bizboard/guide-bizboard.png'],
      },
    ],
  },
  {
    ...
    formats: [
      {
        ...
        notes: ['랜딩 URL 에이전시에 별도 전달 필요'],
        guideImages: ['/images/kakao-pay/guide-text.png', '/images/kakao-pay/guide-layout.png'],
      },
    ],
  },
  {
    ...
    formats: [
      ...
      },
      {
        ...
        guideImages: ['/images/blind/guide-feed-example.png', '/images/blind/guide-logo.png', '/images/blind/guide-exit-ad.png', '/images/blind/guide-specs.png'],
      },
    ],
  },
  {
    ...
    formats: [
      {
        ...
        guideImages: ['/images/remember/guide-margin.png', '/images/remember/guide-square.png', '/images/remember/guide-layout.png', '/images/remember/guide-specs.png', '/images/remember/guide-example.png'],
      },
    ],
  },
  {
    ...
    formats: [
      ...
      },
      {
        ...
        guideImages: ['/images/addison/guide-event-banner.png', '/images/addison/guide-2.png', '/images/addison/guide-3.png'],
      },
    ],
  },
  {
    ...
    formats: [
      {
        ...
        notes: ['최소 3개 소재 권장'],
        guideImages: ['/images/taboola/guide-native.png'],
      },
    ],
  },
];
